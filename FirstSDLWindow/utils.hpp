...
const int GENETIC_NB_MAX_MODIFS = 6;
const int GENETIC_NB_DIV = 1024;

//Core
const int CORE_NB_NEURONE_MAX = 6;

//Neurone
const int NEURONE_HITBOX_SIZE = 48;
const int NEURONE_ALPHA_UNSELECTED = 32;
const int NEURONE_DIST_MAX = 6 * (BLOCK_SIZE / NEURONE_HITBOX_SIZE);
...
//Level
const int LEVEL_RESTART_DELAY = 0;
